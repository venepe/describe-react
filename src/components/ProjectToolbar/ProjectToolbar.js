    ...
    return (
      <Toolbar style={{backgroundColor: Colors.grey100}}>
       ...
       <ToolbarGroup float="right">
         <IconButton onMouseUp={this.props.onClick} onTouchEnd={this.props.onClick} style={{width: '24px', padding: '0px'}}><FontIcon className="material-icons" color={Styles.Colors.grey600}>group</FontIcon></IconButton>
       </ToolbarGroup>
     </Toolbar>
    );
  }
